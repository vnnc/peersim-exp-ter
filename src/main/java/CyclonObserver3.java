...
import cyclonbasic.CyclonBasic;
...
public class CyclonObserver3 implements ObserverProgram {
    ...
    public CyclonObserver3(String prefix) {
    ...
    public void observe(long currentTick, DictGraph observer) {
        List<Node> partialView = ((CyclonBasic) observer.nodes.get(Network.get(0).getID()).pss).getPeers(Integer.MAX_VALUE);
